...
--
-- Host: localhost    Database: pracnexturn
-- ------------------------------------------------------
...
CREATE TABLE `department_master` (
  `Dept_code` decimal(2,0) DEFAULT NULL,
...
CREATE TABLE `designation_master` (
  `Design_code` decimal(3,0) DEFAULT NULL,
...
CREATE TABLE `items` (
  ...
  `SUPPLIERID` decimal(10,0) DEFAULT NULL,
  `MINQTY` decimal(10,0) DEFAULT NULL,
  `MAXQTY` decimal(10,0) DEFAULT NULL,
...
INSERT INTO `weather` VALUES ('Calcutta','West Bengal',105,90,'Rainy'),('Mumbai','Maharashtra',88,69,'Sunny');
...
-- Dump completed on 2025-05-04 15:51:17
